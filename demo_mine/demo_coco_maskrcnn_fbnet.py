...
class COCODemo(object):
    ...
    CATEGORIES = ["__background"] + coco_label_map_list
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="../configs/e2e_mask_rcnn_fbnet.yaml",
        metavar="FILE",
    ...
    cfg.MODEL.WEIGHT = '../weights/fbnet/model_0014500.pth'
    cfg.freeze()

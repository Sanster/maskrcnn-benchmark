...
class rename_custom_ops_lib(distutils.command.build.build):
    def run(self):
        ...
        lib_dir = os.path.join('maskrcnn_benchmark', 'lib')
        ...
        shutil.copy(os.path.join(inst_dir, 'libmaskrcnn_benchmark_customops.' + ext),
                    os.path.join(lib_dir, 'libmaskrcnn_benchmark_customops.' + ext))
